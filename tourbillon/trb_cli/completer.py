...
class TrbCompleter(Completer):
    ...
    def __init__(self, shell, namespace=None, global_namespace=None,
        ...
        delims = terminal.readline.get_completer_delims()
        delims = delims.replace(self.alias_escape, '')
        terminal.readline.set_completer_delims(delims)
        self.get_line_buffer = terminal.readline.get_line_buffer
        self.get_endidx = terminal.readline.get_endidx
