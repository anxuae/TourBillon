...
"""Test unitaires de TourBillon: test des methodes de la classe Tournoi.
...
from tourbillon.core.constantes import E_INCOMPLETE, E_ATTEND_TIRAGE, T_INSCRIPTION
...
class Test01CreationTournoi(unittest.TestCase):
...
class Test02InscriptionTournoi(unittest.TestCase):
...
class Test03EnregistrerTournoi(unittest.TestCase):
...
class Test04ChargerTournoi(unittest.TestCase):
...
class Test04Autre(unittest.TestCase):

    def setUp(self):
        self.tournoi = tournoi.tournoi()

    def test01_joker(self):
        tournoi.charger_tournoi('test.trb')
        self.assertTrue(self.tournoi.generer_numero_joker() < 1001, "verification du joker")
